...
| `wave.build.singularity-image`       | [Singularity](https://quay.io/repository/singularity/singularity?tab=tags) image to use in the build process.                                                           | `quay.io/singularity/singularity:v3.11.4-slim`| false    |
| `wave.build.singularity-image-arm64` | [Singularity](https://quay.io/repository/singularity/singularity?tab=tags) ARM64 image to use in the build process.                                                     | `quay.io/singularity/singularity:v3.11.4-slim-arm64` | true     |
...
| `wave.scan.severity`                  | [Severity levels](https://aquasecurity.github.io/trivy/v0.22.0/vulnerability/examples/filter/) to report in vulnerability scanning. e.g. `MEDIUM,HIGH,CRITICAL`. | `LOW,MEDIUM,HIGH,CRITICAL`            | true     |
