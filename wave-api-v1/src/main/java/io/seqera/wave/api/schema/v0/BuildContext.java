 ...
 */
@JsonPropertyOrder({
    BuildContext.JSON_PROPERTY_LOCATION,
    BuildContext.JSON_PROPERTY_GZIP_DIGEST,
    BuildContext.JSON_PROPERTY_GZIP_SIZE,
    BuildContext.JSON_PROPERTY_TAR_DIGEST,
    BuildContext.JSON_PROPERTY_SKIP_HASHING,
})
...
public class BuildContext {
    ...
    public BuildContext(String location) {
     ...
     *
     * @return The same instance of BuildContext for chaining.
     */
    public BuildContext location(String location) {
        this.location = location;
        return this;
    }
     ...
     * @return The same instance of BuildContext for chaining.
     */
    public BuildContext gzipDigest(String gzipDigest) {
        this.gzipDigest = gzipDigest;
        return this;
    }
     ...
     * @return The same instance of BuildContext for chaining.
     */
    public BuildContext gzipSize(Integer gzipSize) {
        this.gzipSize = gzipSize;
        return this;
    }
     ...
     * @return The same instance of BuildContext for chaining.
     */
    public BuildContext tarDigest(String tarDigest) {
        this.tarDigest = tarDigest;
        return this;
    }
     ...
     * @return The same instance of BuildContext for chaining.
     */
    public BuildContext skipHashing(Boolean skipHashing) {
        this.skipHashing = skipHashing;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        var buildContext = (BuildContext) o;
        return Objects.equals(location, buildContext.location)
            && Objects.equals(gzipDigest, buildContext.gzipDigest)
            && Objects.equals(gzipSize, buildContext.gzipSize)
            && Objects.equals(tarDigest, buildContext.tarDigest)
            && Objects.equals(skipHashing, buildContext.skipHashing);
    }
