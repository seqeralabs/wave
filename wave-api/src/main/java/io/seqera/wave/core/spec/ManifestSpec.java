...
public class ManifestSpec {
    ...
    /**
     * The artifact type for OCI artifacts (e.g., "application/vnd.nextflow.plugin+zip")
     * NOTE: This is only available for OCI Image Manifest Specification v1.0+
     */
    String artifactType;
    ...
    public ManifestSpec(Integer schema, String mediaType, ObjectRef config, List<ObjectRef> layers, Map<String,String> annotations, String artifactType) {
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(schemaVersion, that.schemaVersion) && Objects.equals(mediaType, that.mediaType) && Objects.equals(config, that.config) && Objects.equals(layers, that.layers) && Objects.equals(annotations, that.annotations) && Objects.equals(artifactType, that.artifactType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(schemaVersion, mediaType, config, layers, annotations, artifactType);
    }
    ...
    static public ManifestSpec of(Map<String,?> object) {
        return new ManifestSpec(
                ...
                (String) object.get("artifactType")
        );
    }
