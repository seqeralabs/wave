...
class SurrealPersistenceServiceTest extends Specification implements SurrealDBTestContainer {
    ...
    void "can insert an async build"() {
        ...
        BuildRequest request = new BuildRequest(dockerFile,
                Path.of("."), "buildrepo", condaFile, null, null, BuildFormat.DOCKER,null, null, null,
    ...
    void "an event insert a build"() {
        ...
        BuildRequest request = new BuildRequest("test", Path.of("."), "test", "test", null, null, BuildFormat.DOCKER, Mock(User), null, null, ContainerPlatform.of('amd64'),'{auth}', "test", null, "127.0.0.1", null)
