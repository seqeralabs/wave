...
class SurrealPersistenceServiceTest extends Specification implements SurrealDBTestContainer {
    ...
    def 'should find all scans' () {
        ...
        def CVE3 = new ScanVulnerability('cve-3', 'x3', 'title3', 'package3', 'version3', 'fixed3', 'url3')
        def CVE4 = new ScanVulnerability('cve-4', 'x4', 'title4', 'package4', 'version4', 'fixed4', 'url4')
        def scan1 = new WaveScanRecord('sc-1234_1', '100', null, null, CONTAINER_IMAGE, Instant.now(), Duration.ofSeconds(10), 'SUCCEEDED', [CVE1, CVE2, CVE3, CVE4], null, null)
        def scan2 = new WaveScanRecord('sc-1234_2', '101', null, null, CONTAINER_IMAGE, Instant.now(), Duration.ofSeconds(10), 'SUCCEEDED', [CVE1, CVE2, CVE3], null, null)
        def scan3 = new WaveScanRecord('sc-1234_3', '102', null, null, CONTAINER_IMAGE, Instant.now(), Duration.ofSeconds(10), 'SUCCEEDED', [CVE1, CVE2], null, null)
        def scan4 = new WaveScanRecord('sc-1234_4', '103', null, null, CONTAINER_IMAGE, Instant.now(), Duration.ofSeconds(10), 'SUCCEEDED', [CVE1], null, null)
        when:
        ...
        then:
        persistence.allScans("1234") == [scan4, scan3, scan2, scan1]
    }
