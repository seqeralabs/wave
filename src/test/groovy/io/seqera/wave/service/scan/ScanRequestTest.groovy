...
class ScanRequestTest extends Specification {
    ...
    def 'should create a scan request' () {
        ...
        def build = new BuildRequest('FROM ubuntu', workspace, 'docker.io', null, null, null, BuildFormat.DOCKER, Mock(User), Mock(ContainerConfig), Mock(BuildContext), platform, '{json}', null, null, "", null)
