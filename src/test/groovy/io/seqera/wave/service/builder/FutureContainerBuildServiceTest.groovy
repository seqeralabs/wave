...
class FutureContainerBuildServiceTest extends Specification {
    ...
    def 'should wait to build container completion' () {
        ...
        def req = new BuildRequest(id, dockerfile, null, null, folder, target, Mock(PlatformId), ContainerPlatform.of('amd64'), 'cacheRepo', "10.20.30.40", '{"config":"json"}', null,null , null, null, BuildFormat.DOCKER).withBuildId('1')
