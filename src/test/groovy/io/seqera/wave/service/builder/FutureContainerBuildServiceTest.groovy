...
class FutureContainerBuildServiceTest extends Specification {
    ...
    def 'should wait to build container completion' () {
        ...
        """.stripIndent()
        and:
        def REQ = new BuildRequest(dockerfile, folder, buildRepo, null, null, null, BuildFormat.DOCKER, Mock(User), null, null, ContainerPlatform.of('amd64'),'{auth}', cacheRepo, null, "", null)
