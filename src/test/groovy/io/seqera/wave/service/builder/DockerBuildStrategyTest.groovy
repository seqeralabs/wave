...
class DockerBuildStrategyTest extends Specification {
    ...
    def 'should get singularity build command' () {
        ...
        cmd == ['docker',
                ...
                'sh',
                '-c',
                'apptainer build --fakeroot image.sif /work/foo/bd-d4869cc39b8d7d55_1/Containerfile && singularity push image.sif oras://repo:d4869cc39b8d7d55'
        ]
    ...
    def 'should get singularity build command for arm64 architecture' () {
        ...
        cmd == ['docker',
                ...
                'sh',
                '-c',
                'apptainer build --fakeroot image.sif /work/foo/bd-9c68af894bb2419c_1/Containerfile && singularity push image.sif oras://repo:9c68af894bb2419c'
        ]
