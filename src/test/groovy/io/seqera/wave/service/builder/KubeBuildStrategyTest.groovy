...
class KubeBuildStrategyTest extends Specification {
    ...
    def "request to build a container with right selector"(){
        ...
        when:
        def req = new BuildRequest('from foo', PATH, repo, null, null, USER, null, null, ContainerPlatform.of('amd64'),'{}', cache, null, "", null)
        ...
        when:
        def req2 = new BuildRequest('from foo', PATH, repo, null, null, USER, null, null, ContainerPlatform.of('arm64'),'{}', cache, null, "", null)
