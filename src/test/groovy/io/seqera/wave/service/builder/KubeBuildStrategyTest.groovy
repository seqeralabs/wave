...
class KubeBuildStrategyTest extends Specification {
    ...
    def "request to build a container with right selector"(){
        ...
        def req = new BuildRequest(id, dockerfile, null, null, PATH, target, USER, ContainerPlatform.of('amd64'), cache, "10.20.30.40", '{}', null,null , null, null, BuildFormat.DOCKER).withBuildId('1')
        ...
        when:
        def req2 = new BuildRequest(id, dockerfile, null, null, PATH, target, USER, ContainerPlatform.of('arm64'), cache, "10.20.30.40", '{}', null,null , null, null, BuildFormat.DOCKER).withBuildId('1')
    ...
    def "should get the correct image for a specific architecture"(){
        ...
        def id = BuildRequest.computeDigest(dockerfile, null, null, ContainerPlatform.of('amd64'), repo, null)
        def target = BuildRequest.makeTarget(BuildFormat.DOCKER, repo, id, null, null)
        def req = new BuildRequest(id, dockerfile, null, null, PATH, target, USER, ContainerPlatform.of('amd64'), cache, "10.20.30.40", '{"config":"json"}', null,null , null, null, BuildFormat.DOCKER).withBuildId('1')
        ...
        req = new BuildRequest(id, dockerfile, null, null, PATH, target, USER, ContainerPlatform.of('amd64'), cache, "10.20.30.40", '{}', null,null , null, null, BuildFormat.SINGULARITY).withBuildId('1')
        ...
        req = new BuildRequest(id, dockerfile, null, null, PATH, target, USER, ContainerPlatform.of('arm64'), cache, "10.20.30.40", '{}', null,null , null, null, BuildFormat.SINGULARITY).withBuildId('1')
