...
class KubeBuildStrategyTest extends Specification {
    ...
    def "should get the correct image for a specific architecture"(){
        ...
        strategy.getBuildImage(req) == 'gcr.io/kaniko-project/executor:v1.16.0'
        ...
        strategy.getBuildImage(req) == 'quay.io/singularity/singularity:v4.0.1-slim'
        ...
        strategy.getBuildImage(req) == 'quay.io/singularity/singularity:v4.0.1-slim-arm64'
    }
}
