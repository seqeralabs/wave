...
class BuildStrategyTest extends Specification {
    ...
    def 'should get singularity command' () {
        ...
        cmd == [
                "sh",
                "-c",
                "singularity build image.sif /work/foo/40e8a6dba50e9b3b609a19c12420d3eb/Containerfile --platform linux/amd64 && singularity push image.sif oras://quay.io/wave:40e8a6dba50e9b3b609a19c12420d3eb"
            ]
    }
