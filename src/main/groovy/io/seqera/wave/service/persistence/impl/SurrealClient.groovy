...
interface SurrealClient {
    ...
    @Put('/key/wave_scan_vulnerabilities/{id}')
    Flux<Map<String, Object>> updateScanVulAsync(@Header String authorization, String id, @Body ScanVulnerability scanVulnerability)
}
