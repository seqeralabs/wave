...
interface SurrealClient {
    ...
    @Post('/key/wave_scan_vul/{vulnerabilityId}')
    Flux<Map<String, Object>> updateScanVulAsync(@Header String authorization, String vulnerabilityId, @Body ScanVulnerability scanVulnerability)
}
