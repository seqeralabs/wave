...
class HttpClientFactory {
    ...
    private static volatile HxProxyConfig proxyConfig
     ...
     *
     * @param config The {@link HxProxyConfig} to be applied, or {@code null} to use no proxy
     */
    static void setProxyConfig(HxProxyConfig config) {
