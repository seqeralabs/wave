...
The following sections describe several common usage cases. To get started by creating an example pipeline that uses Wave, see [Nextflow and Wave][start].

[start]: /wave_docs/wave_repo/docs/get-started/nextflow-wave.mdx
