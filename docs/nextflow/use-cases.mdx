---
title: Use cases
description: Use Wave with Nextflow to build, provision, and scan pipeline containers
date: "2024-08-22"
tags: [nextflow, wave, use cases]
---

With Nextflow and Wave, you can build, upload, and manage container images automatically and on demand during pipeline execution.
...
You can then use Conda packages in your pipeline, even on cloud-native platforms like AWS Batch and Kubernetes that do not support the Conda package manager directly.
...
Wave can mirror containers used by your pipeline to a container registry of your choice.
...
Wave scans containers used in your Nextflow pipelines for security vulnerabilities. It identifies vulnerabilities before and during pipeline execution and can block pipelines that use images above your chosen severity threshold.
...
Use Wave containers with the Fusion file system to run pipelines against cloud object storage. With Wave and Fusion, you can use an object storage bucket such as AWS S3 or Google Cloud Storage as your pipeline work directory.
