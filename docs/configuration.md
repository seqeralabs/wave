...
Configure how [Wave Metrics service](https://github.com/seqeralabs/wave/blob/master/docs/metrics.md) provides data about container builds and pulls per org and date with the following options:
