...
Wave builds, augments, and serves container images on demand. This page describes how that happens. See [Features](./features/index.mdx) for the full set of capabilities.
...
See the [provisioning modes table](./features/index.mdx#provisioning-modes) on the Features page for a summary of how each mode combines inputs, outputs, and storage.
