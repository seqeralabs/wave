...
In this guide, you'll build a container from a [Conda package][conda] and freeze that package in your container repository. By freezing the container, you ensure that you can always use it in your Nextflow pipelines.
...
```
nextflow run -with-docker main.nf .
