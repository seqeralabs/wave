...
This guide describes how to provision containers that include Conda package through [Seqera Containers][sc] and use them directly in your Nextflow pipelines. It includes:

- Requesting a conda package from Seqera Container.
