...
The website is built using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/).
...
### Warnings about `README.md`

It's nice to keep this readme in the `docs` folder, where you hopefully found it whilst poking around the docs.
Unfortunately, this causes mkdocs to throw a warning when it builds:

```log
WARNING  -  Both index.md and README.md found. Skipping README.md from /Users/ewels/GitHub/seqeralabs/wave/docs
```
