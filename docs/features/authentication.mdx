...
Wave authenticates to private AWS ECR registries using long-term IAM access keys stored in Seqera Platform. The registry hostname follows the format `<account-id>.dkr.ecr.<region>.amazonaws.com`.
