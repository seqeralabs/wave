...
When security scanning is enabled, Wave scans each platform variant individually.
...
- The Singularity image format is not supported.
...
Multi-platform builds were added in Wave 1.33.0.
