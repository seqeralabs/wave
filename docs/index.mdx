...
:::note
Wave is a Seqera-hosted open source container service available in Seqera Platform. For Seqera Enterprise customers, a licensed self-hosted Wave solution is also available. Contact us [contact us](https://seqera.io/contact-us/) for more information.
:::
