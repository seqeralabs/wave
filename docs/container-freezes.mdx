...
**Reuseability**: Pre-existing images stored in a central registry to avoid repeated builds, reduce overhead, and speed up pipeline execution.
Archiving for compliance: Containers can be stored permanently for compliance or auditing purposes, ensuring a traceable and unaltered record of the environment used for specific analyses.
