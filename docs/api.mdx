...
--header 'Content-Type: application/json' \
--data '{
    "containerImage": "4837ea38a478.ngrok.app/wt/<WAVE_TOKEN>/<REPO>/<IMAGE>",
...
{
    "container": {
        "registry": "4837ea38a478.ngrok.app",
        "hostName": "https://4837ea38a478.ngrok.app",
        "imageName": "wt/<WAVE_TOKEN>/<REPO>/<IMAGE>",
